...
public class ProbabilityDistribution{
   	...
   	private String randomChoice = ""; //Variable for random number quality choice
   	...
   	public ProbabilityDistribution(String randomChoiceInput){
      		...
      		if(randomChoice.equals("") || randomChoice.equals("random")){
         		randomUniformObject = new Random(); //Initialize random number object
			...
			try{
					...
					byteValues = new byte[20];
            			...
            			System.out.println("Error retriving current OS for random number generation");
         		}//End catch
      		}else{
         		System.out.println("Incorrect input for random quality choice");
      		}//End else
   	}//End main
   	...
   	public double nextGaussian(){
      		...
      		return randomUniformObject.nextGaussian(); //Return values from default algorithm for normal distribution
   	}//End nextGaussian
   	//Getters
